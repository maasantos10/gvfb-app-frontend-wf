(function(){
  angular.module('workflowGfbvApp').factory('auth', [
    '$http',
    'consts',
    AuthFactory
  ])
  ...
  function AuthFactory($http, consts) {
    ...
    function signDocument(user, callback) {

      const url = 'signDocument'
    ...
    return { signup, login, logout, getUser, validateToken, signDocument }
  }
})()
